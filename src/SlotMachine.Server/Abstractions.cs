...
public class OutstandingStake
{
    ...
    /// <summary>What was taken for a pull and has not been returned.</summary>
...
/// <summary>
/// Records what the table owes the player while a pull is in flight.
///
